(function () {
  ...
  var css = [
    /* wrap */
    '.cw-wrap{position:fixed;top:58px;left:20px;z-index:9999;display:flex;flex-direction:column;align-items:flex-start;gap:8px;}',
    /* option items */
    ...
    '@media(max-width:480px){.cw-wrap{top:54px;left:16px;}.cw-btn{width:40px;height:40px;}}'
  ].join('');
